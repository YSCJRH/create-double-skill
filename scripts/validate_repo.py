...
REQUIRED_PATHS = [
    ...
    "create_double/__init__.py",
    "create_double/domain/__init__.py",
    "create_double/domain/profile_model.py",
    "create_double/interview/__init__.py",
    "create_double/interview/flow.py",
    "create_double/storage/__init__.py",
    "create_double/storage/repository.py",
    "create_double/rendering/__init__.py",
    "create_double/rendering/renderers.py",
    "create_double/system/__init__.py",
    "create_double/system/health.py",
